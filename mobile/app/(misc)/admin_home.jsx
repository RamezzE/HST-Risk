...
const AdminHome = () => {
  ...
  return (
    ...
    >
      <View className="flex flex-col justify-start px-4 py-5 w-full">
        <View>
          <BackButton
            style="w-[20vw] mb-6"
            size={32}
          ...
          <Text className="mt-1 font-pregular text-black text-3xl text-center">
            {state.war}
          </Text>
        </View>

        <View
          className="flex-col flex justify-start mt-3 px-2 rounded-md"
          ...
          {state.currentAttack != null ? (
            <View className="flex flex-col justify-between py-4">
              <View>
                ...
                <Text className="px-5 py-2 font-pbold text-green-500 text-xl text-left">
                ...
                <Text className="px-5 py-2 font-pbold text-red-500 text-xl text-left">
